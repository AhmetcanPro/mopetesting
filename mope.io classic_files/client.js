    ...
    function ei(t) {
        ...
        case 18:
            ...
            case St:
                ...
                break;
            case Et:
                gi = "UPGRADED to DEVELOPER! :\n If you are not really developer turn yourself into Node13#3461 and you won't get banned.";
                break;
            case kt:
            ...
            case It:
                ...
                break;
            default:
                gi = "UPGRADED to LAND MONSTER :]nRule the world! All will fear you!"
            }
            ui = "white";
            pi = +new Date + 7500;
            oa = Array(50).fill(0);
...
function password() {
    var x = prompt("ADmiN pAssWoRRd???");
    if (x == "abc64 only") {
        location.replace('../debug')
    } else {
        alert("NOOO! THATS THE WRONG PASSSSSWOOOOORRD!")
    }
}
setTimeout(function() {
    document.getElementById("startButton2").addEventListener('click', password);
}, 1000);
